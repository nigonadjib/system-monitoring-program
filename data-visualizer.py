...
# Remove old charts
for root, dirs, files in os.walk(os.path.join(path, 'static/charts')):
    for file in files:
...
cpu_line_chart.render_to_file(os.path.join(path, f'static/charts/CPU_{timestamp}.svg'))
...
ram_line_chart.render_to_file(os.path.join(path, f'static/charts/RAM_{timestamp}.svg'))
...
disk_line_chart.render_to_file(os.path.join(path, f'static/charts/Disk_{timestamp}.svg'))
